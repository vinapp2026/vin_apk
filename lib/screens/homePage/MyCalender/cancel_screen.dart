...
class CancelScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: FutureBuilder(
          future: GetUpcomingInfoServices.getUpComingInfo(stadiumId: 3),
            ...
            if (snapshot.hasData &&
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    print(getUpcomingInfoModel.data![index].bookingStatus);
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          padding: EdgeInsets.symmetric(horizontal: 8,vertical: 5),
                                            ...
                                            child: Center(
                                              child:CustomText(
                                                title:getUpcomingInfoModel.data![index].bookingStatus=="3"?
                                                "Canceled":"Failed",
                                                fontSize: 12,
                                                color: blackColor,
                                              )
